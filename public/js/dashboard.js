$(function () {
    ...
    $.each(vendors, function (k, v) {
        vendor_data[k] = {};
        vendor_data[k].value = v.total;
        vendor_data[k].label = v.title;
        vendor_data[k].color = colors[k];
        vendor_data[k].highlight = colors[k];
    })
    ...
    pieChart.Doughnut(vendor_data, pieOptions);
