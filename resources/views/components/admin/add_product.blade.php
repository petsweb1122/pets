...
<div class="box box-primary">
    ...
    {!! Form::open(['url' => 'admin/products/add-variation-product']) !!}
    <div class="box-body">
        <div class="row">
            ...
            <div class="form-group col-md-12 input-group-sm">
                ...
                {!! Form::textarea('description', '', ['class' => 'form-control description-area']) !!}
            </div>
            <div class="form-group col-md-12 input-group-sm">
            ...
            @if (!empty($categories))
                <div class="form-group col-md-3 input-group-sm">
                    ...
                    {!! Form::select('all_categories[]', $categories, !empty($selected_categories) ? $selected_categories : 0, ['class' => 'form-control  select-multiple', 'multiple' => 'multiple']) !!}
                </div>
            @endif
            @if (!empty($brands))
                <div class="form-group col-md-3 input-group-sm">
                    {!! Form::label('all_brands', 'Brand:') !!}
                    {!! Form::select('all_brands', $brands, !empty($productData->detail[0]->brand) ? $productData->detail[0]->brand : '', ['class' => 'form-control  select-single']) !!}
                </div>
            @endif
            @if (!empty($vendors))
                <div class="form-group col-md-3 input-group-sm">
                    {!! Form::label('all_vendors', 'Vendor:') !!}
                    {!! Form::select('all_vendors', $vendors, !empty($productData->detail[0]->vendor) ? $productData->detail[0]->vendor : '', ['class' => 'form-control  select-single']) !!}
                </div>
            @endif
        </div>
