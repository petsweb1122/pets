                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check">
                                ...
                                <p class="" style="font-size:16px">I agree to the <a
                                        ...
                                        href="{{ url('/terms-and-conditions.html') }}">terms & conditions</a> & <a
                                        style="font-size:16px" class="text-primary"
                                        title="Privacy Policy" href="{{ url('/privacy-policy.html') }}">privacy policy</a></p>
                                </label>
                            </div>
                        </div>
                    </div>
