        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 logo text-center">
                    <p><a href="{{ url('/') }}"><img alt="Logo" width="80%" height="" src="{{asset('front/img/login-logo.png')}}"></a></p>
                </div>
            </div>
            <div class="row">
                ...
                @if (!empty(session()->get('message')))
                    ...
                    {!! Form::open(['url' => 'admin/login']) !!}
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" 
                                        ...
                                        required autocomplete="email" autofocus placeholder="abc@example.com">
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        ...
                                        viewBox="0 0 448 512" class="svg-inline--fa fa-lock-alt fa-w-14"><path fill="currentColor" 
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="consent">
                                         <p class="text-white" style="font-weight:400; font-size:16px">I agree to the <a  class="badge badge-success" style="font-size:16px" href="https://petssified.com/terms-and-conditions">terms & conditions</a> & <a style="font-size:16px" class="badge badge-success" href="https://petssified.com/privacy-policy">privacy policy</a></p>
                                    </label>
                                </div>
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="form-group">
                            <div class="g-recaptcha" data-sitekey="6LfJoLQZAAAAANK49C_US7lnkYnU3Spiu-QruVJf" data-callback="verifyRecaptchaCallback" data-expired-callback="expiredRecaptchaCallback"></div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-12 text-center">
                                <p class="bottom-link"><a href="{{url('/register.html')}}" class="text-warning">
                                     Register
                                </a> | <a href="{{url('/password-reset-email.html')}}" class="text-warning">
